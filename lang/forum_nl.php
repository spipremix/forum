...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 berichten schrappen).',
	...
	'forum_saisie_texte_info' => 'In dit formulier mag je de SPIP afkortingen gebruiken: <code>[->url] {{vet}} {cursief} <quote> <code></code> en de HTML codes <code><q> <del> <ins></code>. Om een paragraaf aan te maken, laat gewoon lege lijnen in.',
...
De publieke forums kunnen per artikel toegestaan worden. Ze worden niet toegestaan op rubrieken en nieuwsberichten, enz.',
	'info_envoi_forum' => 'Versturen van de forumbijdragen aan de auteurs van de artikels',
	...
	'info_option_email' => 'Wanneer een bezoeker van de site een nieuw bericht in het forum opstelt dat aan een artikel is gekoppeld, kunnen de auteurs van het artikel per email over de bijdrage worden geïnformeerd. Geef voor elk soort forum aan of deze keuze moet wporden toegepast.',
	...
	'info_question_visiteur_ajout_document_forum_format' => 'Als je alle soorten documenten wilt toestaan die door SPIP als betrouwbaar worden beschouwd, ze je een ster. Om niets toe te staan, niets invullen.',
	...
	'texte_en_cours_validation_forum' => 'Aarzel niet om uw advies te geven via het gekoppelde forum.',
	...
	'titre_page_forum_suivi' => 'Opvolgen van de forums',
	'titre_selection_action' => 'Selectie',
	'tout_voir' => 'Alles bekijken',

	// V
	'voir_messages_objet' => 'boodschappen bekijken'
);
