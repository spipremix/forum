...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// F
	'form_forum_message_commentaire' => 'Un messatge, una remarca ?',
	'forum' => 'Fòro',
	...
	'forum_attention_trop_caracteres' => '<b>Atencion !</b> lo voastre messatge es tròp long (@compte@ caractèrs) : per si poder registrar, cau pas que passe @max@ caractèrs.',
	'forum_avez_selectionne' => 'Avètz seleccionat :',
	'forum_cliquer_retour' => 'Clicatz <a href=\'@retour_forum@\'>aquí</a> per continuar.',
	'forum_forum' => 'fòro',
	'forum_info_modere' => 'Aqueu fòro es moderat à priòri : la voastra contribucion apareisserà après èstre estada validada d\'un administrator dau sit.',
	'forum_lien_hyper' => '<b>Ligam ipertèxt</b> (opcionau)',
	'forum_message_definitif' => 'Messatge definitieu: mandar au sit',
	'forum_message_trop_long' => 'Lo voastre messatge es tròup lòng. La talha maximala es de 20000 caractèrs.',
	...
	'forum_qui_etes_vous' => '<b>Cu siètz ?</b> (opcionau)',
	...
	'forum_votre_nom' => 'Lo voastre nom (ò pseudonim) :',
 ...
 de moderacion predefinits:</i>',
	...
	'info_gauche_suivi_forum_2' => 'La pàgina de <i>seguit dei fòros</i> es una aisina de gestion dau voastre sit (ma es pas un espaci de discussion ò de redaccion). Fa paréisser toti li contribucions dei fòros dau sit, autant ben aqueli dau sit public coma de l\'espaci privat e vos permete de gerar aqueli contribucions.',
