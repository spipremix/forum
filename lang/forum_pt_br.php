...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_moderation_priori' => 'Moderação prévia (as contribuições só serão exibidas publicamente após a aprovação dos administradores).', # MODIF
 ...
 (as contribuições serão exibidas assim que forem enviadas; os administradores poderão excluí-las em seguida).',
	...
	'forum_attention_trop_caracteres' => '<b>Atenção!</b> sua mensagem é muito longa (@compte@ caracteres): para que ela seja gravada, ela não pode ultrapassar @max@ caracteres.', # MODIF
	'forum_avez_selectionne' => 'Você selecionou:',
	'forum_cliquer_retour' => 'Clique <a href=\'@retour_forum@\'>aqui</a> para continuar.',
	'forum_forum' => 'fórum',
	'forum_info_modere' => 'Este fórum é moderado a priori: a sua contribuição só será exibida após ser validada por um administrador do site.', # MODIF
	'forum_lien_hyper' => '<b>Link hipertexto</b> (opcional)', # MODIF
	'forum_message' => 'Votre message', # NEW
	'forum_message_definitif' => 'Mensagem definitiva: enviar para o site',
	'forum_message_trop_long' => 'Sua mensagem é muito longa. O tamanho máimo é de 20000 caracteres.', # MODIF
	...
	'info_config_forums_prive' => 'Na área restrita do site, você pode ativar diversos tipos de fóruns:', # MODIF
	...
	'info_gauche_suivi_forum_2' => 'A página de <i>acompanhamento dos fóruns</i> é uma ferramenta de gestão do seu site (e não um espaço de discussão ou de redação). Ela exibe todas as contrubuições do fórum público desta matéria e permite-lhe gerenciar suas contribuições.', # MODIF
