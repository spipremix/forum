...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 администраторите могат да ги изтриват).',
	...
	// F
	'form_forum_message_commentaire' => 'Коментар?',
	'forum' => 'Форум',
  ...
  който Ви бе предоставен. Ако все още не сте регистрирани, необходимо е да',
	...
	'info_activer_forum_public' => '<i>За достъп до публичните форуми, изберете от модерирането режим "по подразбиране":</i>',
 ...
 случаи за статиите, а забранени за рубриките, новините и др.',
	...
	'info_gauche_suivi_forum_2' => 'Страницата <i>Допълнения във форумите</i> е инструмент за управление на сайта (а не зона за дискусии или за публикации). Тя показва целия принос от съобщения в публичния форум на статията и позволява боравенето с тези съобщения.',
