...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_moderation_priori' => 'پيامها پس از تأئيد گردانند گان سايت نمايان ميشوند', # MODIF
	'bouton_radio_modere_abonnement' => 'براى مشتركين',
	'bouton_radio_modere_posteriori' => 'اعلان پيش از تأئيد', # MODIF
	'bouton_radio_modere_priori' => 'اعلان پس از تأئيد', # MODIF
 ...
 (پيامها بمحض فرستاده شدن نمايان ميشوند سپس گردانند گان سايت ميتوانند آنها را حذف كنند)',
	...
	'icone_valider_repondre_message' => 'معتبر كردن & پاسخ به اين پيام', # MODIF
	...
	'info_config_forums_prive' => 'در قسمت شخصي سايت مي‌توانيد چند نوع سخنگاه را فعال كنيد:', # MODIF
	...
	'info_gauche_suivi_forum_2' => 'صفحه دنباله سخنگاه از ابزار اداره سايتتان ميباشد (و نه مكانى براى بحث يا نگارش) و امكان اعلان تمام پيامها ى سخنگاه همگانى و خصوصى و همچنين اداره پيامها را بشما ميدهد.', # MODIF
	...
	'info_question_visiteur_ajout_document_forum' => 'اگر مايليد به بازديد‌كنندگان اجازه دهيد كه سند‌هايي (تصوير، صدا و . . . ) را به پيام‌هايشان در سخنگاه بچسبانند، فهرست توسعه‌هاي مجاز براي سند‌ها را براي سخنگاه‌ها مشخص كنيد (ex: gif, jpg, png, mp3).', # MODIF
	'info_question_visiteur_ajout_document_forum_format' => 'اگر مايليد به تمام انواع سند‌هايي كه مورد اعتماد اسپيپ است اجازه بدهيد، يك ستاره بگذاريد. اگر اجازه نمي‌دهيد هيچ كار نكنيد.', # MODIF
	...
	'lien_reponse_site_reference' => ':پاسخ به سايت مرجع', # MODIF
	...
	'texte_en_cours_validation' => 'مقاله‌ها،‌خرها و سخنگاه‌هاي زير براي انتشار پيشنهاد شده‌اند.', # MODIF
