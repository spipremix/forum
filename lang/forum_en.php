...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 then delete them if necessary).',
	...
	'forum_attention_trop_caracteres' => '<b>Warning !</b> Your message is too long (@compte@ characters) : a message cannot contain more than @max@ characters.', # MODIF
	'forum_avez_selectionne' => 'You have selected:',
	'forum_cliquer_retour' => 'Click  <a href=\'@retour_forum@\'>here</a> to continue.',
	'forum_forum' => 'forum',
	'forum_info_modere' => 'Posts in this forum are moderated before publication: your contribution will only appear after being validated by a site administrator.', # MODIF
	'forum_lien_hyper' => 'Hypertext link',
	'forum_message' => 'Your post',
	'forum_message_definitif' => 'Finished editing: submit message',
	'forum_message_trop_long' => 'Your message is too long. Maximum length is  20000 characters.', # MODIF
...
. If you have not yet registered, you must',
	...
	'icone_valider_repondre_message' => 'Confirm & reply to this post', # MODIF
	...
	'info_config_forums_prive' => 'You can activate various types of forum in the private area:', # MODIF
 ...
 basis for articles; they will be permanently disabled for sections, news, etc.',
	...
	'info_gauche_suivi_forum_2' => 'The <i>forums management</i> page is a site management tool, not a discussion or editing area. It displays all contributions to the forums (both on the public site and in the private area) and allows you to manage these contributions.', # MODIF
	...
	'info_question_visiteur_ajout_document_forum' => 'If you want to allow visitors to attach documents (images, sound files, etc.) to their forum posts, indicate which file extensions are accepted (e.g. gif, jpg, png, mp3).', # MODIF
	...
	'texte_en_cours_validation' => 'Articles, news items, forums below are submitted for publication.', # MODIF
